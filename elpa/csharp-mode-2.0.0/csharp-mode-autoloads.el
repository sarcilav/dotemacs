...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "csharp-mode-tests" '("assess-face-in-" "c-mode-hook-run" "csharp-" "debug-res" "list-repeat-once")))
